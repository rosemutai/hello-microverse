...
This project built with HTML & CSS to learn how to configure html&CSS linters
and how to Document a GitHub repository in a professional way.
...
- [Live Demo Link](https://rosemutai.github.io/hello-microverse/)
...
- GitHub Account.
- Installation of NPM
- Installation of Live Server plugin in Visual 
...
Go to github and find the repository with hello-microverse
...
Open the cloned folder in visual Studio. Right click te inde.htm source code and click 
...
Example:
```sh
git@github.com:rosemutai/hello-microverse.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
Feel free to check the [https://github.com/rosemutai/hello-microverse/issues.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- SUPPORT -->
...
This project is [MIT](https://github.com/rosemutai/hello-microverse/blob/add-descriptive-readme-file/LICENSE.txt) licensed.
